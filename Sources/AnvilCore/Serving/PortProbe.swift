...
/// Checks whether a loopback TCP port is actually free before handing
/// it to a new `LLMServer` — not just "not one of ours," since a
/// leftover process (a previous Anvil run, oMLX, anything else) can
